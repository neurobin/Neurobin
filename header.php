...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.5&appId=748792438520405";
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li>
							...
							<ul >
								<li>
									<a class="menu-item" href="Projects/Softwares/linsofts.php">Linux</a>

								</li>
								<li>
									<a class="menu-item" href="Projects/Softwares/winsofts.php">Windows</a>
								</li>
								<li>
